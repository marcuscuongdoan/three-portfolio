...
export default function Home({ playCharacterAnimation, adjustCamera }: HomeProps) {
  ...
  return (
    <SectionLayout 
      id="home" 
      ref={homeRef}
      className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 justify-end items-end"
    >
      <motion.div
        ...
        className="text-foreground space-y-6 max-w-2xl text-right"
      >
        {/* Greeting */}
        <motion.div
          ...
          className="space-y-2"
        >
          <p className="text-lg md:text-xl text-muted-foreground">Hi there! 👋</p>
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-blue-200 via-blue-300 to-blue-100 bg-clip-text text-transparent">
            I'm Cuong – Marcus
          </h1>
        </motion.div>
        ...
        >
          ...
          <a
            ...
            className="group flex items-center gap-3 px-5 py-3 bg-gradient-to-r from-blue-50/80 to-blue-100/80 hover:from-blue-100 hover:to-blue-200 border border-blue-200 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-300/30"
          >
            <svg
              className="w-6 h-6 fill-blue-400 group-hover:fill-blue-500 transition-colors"
              viewBox="0 0 24 24"
            ...
            <span className="font-medium text-blue-600 group-hover:text-blue-700 transition-colors">GitHub</span>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-3 px-5 py-3 bg-gradient-to-r from-blue-200 to-blue-300 hover:from-blue-300 hover:to-blue-400 border border-blue-300 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-300/50"
          >
            <svg
